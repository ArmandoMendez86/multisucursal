            ...
            <form id="product-form">
                ...
                <div class="p-6 modal-body overflow-y-auto">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-x-6 gap-y-4">
                        <h3 class="md:col-span-3 text-lg font-semibold text-[var(--color-text-primary)] mb-2">Precios y
                            Stock</h3>
                        <div>
                            <label for="costo"
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="costo" name="costo" placeholder="0.00"
                                    class="w-full bg-[var(--color-bg-primary)] text-[var(--color-text-primary)] rounded-md p-2 pl-7 border border-[var(--color-border)] focus:ring-[var(--color-accent)] focus:border-[var(--color-accent)]"
                                    required>
                            </div>
                        </div>
                        <div>
