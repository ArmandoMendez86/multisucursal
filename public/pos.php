...
<body class="bg-[var(--color-bg-primary)] text-[var(--color-text-primary)] flex h-screen">
  ...
  <main class="flex-1 flex flex-col overflow-hidden">
    ...
    <div class="flex-1 flex lg:flex-row flex-col overflow-y-auto">
      ...
      <div class="lg:w-3/5 w-full bg-[var(--color-bg-secondary)] flex flex-col p-4 shadow-lg">
        ...
        <div class="py-4 space-y-3 border-b border-[var(--color-border)]">
          ...
          <div id="address-selection-container" class="hidden">
            ...
            <select id="client-address-select"
              class="w-full bg-[var(--color-bg-secondary)] text-[var(--color-text-primary)] rounded-md p-2 border border-[var(--color-border)]"></select>
          </div>

          <button id="open-pending-sales-btn"
            class="w-full text-sm text-blue-400 hover:text-blue-300 font-semibold py-2 px-3 bg-[var(--color-bg-primary)]/[0.5] hover:bg-[var(--color-bg-primary)] rounded-lg flex items-center justify-center gap-2 mt-2">
        ...
        <div class="grid grid-cols-3 gap-4 pt-4 border-t border-[var(--color-border)]">
          <button id="cancel-sale-btn" class="bg-red-600 hover:bg-red-500 text-white font-bold py-3 rounded-lg">
            Cancelar
          </button>
          <button id="save-sale-btn"
            class="bg-[var(--color-accent)] hover:bg-[var(--color-accent-hover)] text-white font-bold py-3 rounded-lg disabled:bg-gray-500 disabled:cursor-not-allowed"
            disabled>
            Guardar
          </button>
